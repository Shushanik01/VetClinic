import { SignUpForm } from '~/pages/sign-up-page/sign-up-form';
import { AuthMarketingPanel } from '~/components/ui/components/auth-marketing-panel';
import { SIGN_UP_MARKETING_CONTENT } from '~/pages/sign-up-page/sign-up-content';
